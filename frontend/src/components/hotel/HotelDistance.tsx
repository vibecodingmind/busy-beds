...
export default function HotelDistance({ latitude, longitude }: HotelDistanceProps) {
  ...
  if (loading) {
    return (
      <p className="text-sm text-black dark:text-zinc-400">Getting distance...</p>
    );
  }
  ...
  return (
    <p className="flex items-center gap-1.5 text-sm text-black dark:text-zinc-400">
      <svg className="h-4 w-4 text-black dark:text-zinc-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
