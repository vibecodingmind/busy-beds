    ...
    <div className="space-y-0">
      ...
      <div className="grid grid-cols-2 gap-2 overflow-hidden rounded-xl md:grid-cols-[2fr_1fr]">
        ...
        >
          ...
          />
          {/* Show all photos - overlay on hero */}
          <div className="absolute bottom-4 right-4">
            <span className="flex items-center gap-2 rounded-lg border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-800 shadow-md dark:border-zinc-600 dark:bg-zinc-900 dark:text-zinc-200">
