...
export const tanzaniaRegions: TanzaniaRegion[] = [
  ...
  },
  {
    region: 'Dodoma',
    wards: [
      'Ahamadi', 'Ajua', 'Ambari', 'Arusha Chini', 'Bahai', 'Bargati', 'Bashnet', 'Berege', 'Biriq', 'Bisarara',
      'Bonga', 'Boya', 'Buigiri', 'Bulimwa', 'Bundu', 'Chamina', 'Chandama', 'Chegeni', 'Chemba', 'Chikuyu',
      'Chirau', 'Chole', 'Chunyu', 'Dabalo', 'Daha', 'Dakawa', 'Daldale', 'Dominated', 'Donziga', 'Fufu',
      'Ghasaga', 'Gidagala', 'Gombelo', 'Goima', 'Golinja', 'Guchi', 'Gulwe', 'Gungi', 'Gwandi', 'Habaka',
      'Hai', 'Hamayombo', 'Handel', 'Hembeti', 'Himo', 'Hinju', 'Hodumi', 'Hombolo', 'Idugala', 'Ikharus',
      'Ikwiriri', 'Ileje', 'Ilyamchele', 'Iringa', 'Itiso', 'Jaja', 'Jelego', 'Jibondo', 'Jughai', 'Kagongwa',
      'Kakeseka', 'Kalamata', 'Kalema', 'Kanga', 'Kanyosha', 'Kaporogwe', 'Karakata', 'Kasanga', 'Kashe', 'Katesh',
      'Kavua', 'Kazamoyo', 'Kazija', 'Kazole', 'Kibakwe', 'Kibara', 'Kibay', 'Kibini', 'Kibiti', 'Kibugala',
      'Kibwigwa', 'Kidahwe', 'Kidatu', 'Kidera', 'Kidete', 'Kigala', 'Kigamba', 'Kigwe', 'Kilemba', 'Kilindi',
      'Kilo', 'Kilua', 'Kimandwa', 'Kinyasenzenge', 'Kisanda', 'Kisanga', 'Kisekwa', 'Kisokwe', 'Kitete', 'Kiti',
      'Kitonga', 'Kitoto', 'Kizigo', 'Kondoa', 'Korongoro', 'Kudaru', 'Kuji', 'Kukayanga', 'Kulig', 'Kumudini',
      'Kungu', 'Kusaga', 'Kwadibete', 'Kwai', 'Kwaluhande', 'Kwashemshi', 'Laiboon', 'Lamaiti', 'Lalta', 'Langelz',
      'Lawi', 'Leki', 'Lekitatu', 'Lembap', 'Likamba', 'Likoni', 'Lomato', 'Lope', 'Luganengoro', 'Lughalamo',
      'Lukokelo', 'Lupiro', 'Mabugai', 'Madizini', 'Magu', 'Makanda', 'Makangale', 'Makete', 'Makuru', 'Makwi',
      'Malanga', 'Mamba', 'Mammba', 'Mangoto', 'Mani', 'Manyata', 'Manyoni', 'Mbuga', 'Mbutu', 'Mbuzi'
    ],
  },
  {
    region: 'Geita',
