        ...
        <div className="flex-1 min-w-0">
          <div className="rounded-2xl border border-black/10 dark:border-zinc-700/80 bg-white dark:border-zinc-700/80 dark:bg-zinc-900/60 backdrop-blur-xl p-6 shadow-sm md:p-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-black dark:text-zinc-100 md:text-3xl">
                  {hotel.name}
                </h1>
                {(hotel.avg_rating != null && hotel.review_count != null && hotel.review_count > 0) && (
                  <p className="mt-1 flex items-center gap-1.5 text-sm text-black dark:text-zinc-400">
            ...
            {(hotel.contact_phone || hotel.contact_email || hotel.contact_whatsapp) && (
              <div className="mt-6 space-y-2">
                <h3 className="text-sm font-medium text-black dark:text-zinc-300">Contact</h3>
                <div className="flex flex-wrap gap-6">
                  {hotel.contact_phone && (
                    <a href={`tel:${hotel.contact_phone}`} className="flex items-center gap-2 text-zinc-700 hover:text-black dark:text-zinc-400 dark:hover:text-zinc-100">
                  ...
                  {hotel.contact_email && (
                    <a href={`mailto:${hotel.contact_email}`} className="flex items-center gap-2 text-zinc-700 hover:text-black dark:text-zinc-400 dark:hover:text-zinc-100">
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {hotel.contact_whatsapp && (
                    <a
                      ...
                      className="flex items-center gap-2 text-zinc-700 hover:text-black dark:text-zinc-400 dark:hover:text-zinc-100"
                    >
            ...
            {hasCoords && (
              <div className="mt-6">
                <h3 className="mb-2 text-sm font-medium text-black dark:text-zinc-300">Location</h3>
                <HotelMap
