            ...
            {(hotel.contact_phone || hotel.contact_email || hotel.contact_whatsapp) && (
              <div className="mt-6 space-y-2">
                ...
                <div className="flex flex-wrap gap-6">
                  ...
                  {hotel.contact_email && (
                    <a href={`mailto:${hotel.contact_email}`} className="flex items-center gap-2 text-zinc-700 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {hotel.contact_whatsapp && (
                    <a
                      ...
                      className="flex items-center gap-2 text-zinc-700 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100"
                    >
