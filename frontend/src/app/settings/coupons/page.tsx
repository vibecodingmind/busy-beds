...
export default function MyCouponsPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-card">
      {/* Header Breadcrumb */}
      <div className="flex items-center justify-between border-b border-border px-8 py-5 text-sm print:hidden">
      ...
      <div className="p-8 space-y-6 flex-1 print:space-y-0 print:m-0 print:p-0">
        ...
        <div className="flex gap-2 border-b border-border print:hidden">
          {(['active', 'used', 'expired'] as const).map((t) => (
            <button
              ...
              type="button"
              onClick={() => setTab(t)}
              className={`border-b-2 px-4 py-3 text-sm font-medium transition-colors ${tab === t
        ...
        <div className="mt-8 flex flex-col gap-6 lg:flex-row lg:items-stretch print:mt-0 print:block">
          ...
          <div className="lg:min-w-[420px] print:w-full print:max-w-none print:block">
            {selected ? (
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-black/[0.02] p-12 dark:bg-white/[0.02]">
                <p className="text-muted">Select a coupon to view details</p>
              </div>
            )}
          </div>
        </div>
