...
export default function AdminHotelAccountsPage() {
  ...
  return (
    <div>
      ...
      {accounts.length === 0 ? (
        <div className="mt-8 rounded-lg border border-zinc-200 bg-zinc-50 p-8 text-center text-zinc-600">
          ...
          <table className="min-w-full divide-y divide-zinc-200">
            <thead className="bg-zinc-50">
              <tr>
                ...
                <th className="px-4 py-2 text-left text-sm font-medium text-zinc-700">Submitted</th>
                <th className="px-4 py-2 text-right text-sm font-medium text-zinc-700">Action</th>
              </tr>
            </thead>
